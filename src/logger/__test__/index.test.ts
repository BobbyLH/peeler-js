...
describe("Logger's test module", function () {
  ...
  it('Logger\'s prototype', function () {
    ...
    expect(proto).to.have.property('success').to.be.a('function')
  ...
  it('const logger_default = new Logger()', function () {
    ...
    expect(logger_default.log).to.be.a('function')
    expect(logger_default.detail).to.be.a('function')
    expect(logger_default.logErr).to.be.a('function')
    expect(logger_default.error).to.be.a('function')
    expect(logger_default.logInfo).to.be.a('function')
    expect(logger_default.info).to.be.a('function')
    expect(logger_default.logWarn).to.be.a('function')
    expect(logger_default.warn).to.be.a('function')
    expect(logger_default.success).to.be.a('function')
    expect(logger_default.setDebug).to.be.a('function')
    expect(logger_default.setLevel).to.be.a('function')
    expect(logger_default.setPrefix).to.be.a('function')
  })
  ...
  it('const logger_cutstom = new Logger(config)', function () {
    ...
    expect(logger_cutstom.log).to.be.a('function')
    expect(logger_cutstom.detail).to.be.a('function')
    expect(logger_cutstom.logErr).to.be.a('function')
    expect(logger_cutstom.error).to.be.a('function')
    expect(logger_cutstom.logInfo).to.be.a('function')
    expect(logger_cutstom.info).to.be.a('function')
    expect(logger_cutstom.logWarn).to.be.a('function')
    expect(logger_cutstom.warn).to.be.a('function')
    expect(logger_cutstom.success).to.be.a('function')
    expect(logger_cutstom.setDebug).to.be.a('function')
    expect(logger_cutstom.setLevel).to.be.a('function')
    expect(logger_cutstom.setPrefix).to.be.a('function')
  })
})
